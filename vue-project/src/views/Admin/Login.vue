<template>
  <div>
    <v-img class="mx-auto my-6" max-width="228" src="https://www.movis-logistics.com/images/logo-dark.png"></v-img>

    <v-card class="mx-auto pa-5 pb-8" elevation="44" max-width="448" rounded="lg" style="margin-top: 50px;">
      <div>
        <h2> Admin Login</h2>
      </div>
      ...
      <v-card class="mb-12" color="surface-variant" variant="tonal">
        <v-card-text class="text-medium-emphasis text-caption">
          <h5> Warning: After 3 consecutive failed login attempts, you account will be temporarily locked for three
            hours. If you must login now, you can also click "Forgot login password?" below to reset the login password.
          </h5>
        </v-card-text>
      </v-card>
